...
namespace Proxies\__CG__\Thierry\CatalogueBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Image extends \Thierry\CatalogueBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Thierry\\CatalogueBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'Thierry\\CatalogueBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'Thierry\\CatalogueBundle\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'Thierry\\CatalogueBundle\\Entity\\Image' . "\0" . 'tempFilename', '' . "\0" . 'Thierry\\CatalogueBundle\\Entity\\Image' . "\0" . 'temp', '' . "\0" . 'Thierry\\CatalogueBundle\\Entity\\Image' . "\0" . 'file'];
        }
